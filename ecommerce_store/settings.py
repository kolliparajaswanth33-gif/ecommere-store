...
SECRET_KEY = 'django-insecure-3h%z8t&5odqal!#(zpmxoi!*na@u^t5_qiarv%q9byigp16t04'
...
# Gmail settings: set these values as Windows environment variables, not in code.
